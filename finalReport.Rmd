...
# )
```
From here we see some of the names again that appeared on the top averages graph. Notibly Carey Price and Sergei Bobrovsky.  We also want to point out that many of the top goalies peer season were with the team that either won the Stanely Cup or are with a team that was in the top of the standings.   ->>> do we want to show a graph for this? or should I leave it? 
